...
O padrão de projeto Singleton é usado quando você deseja ter apenas uma única instância de uma classe 
em todo o seu aplicativo, garantindo que haja apenas um ponto de acesso global para essa instância. 
Segue exemplo de como implementar o padrão Singleton em JavaScript:
*/
...
const irrf = new IRRF();
console.log(irrf.calculaIRRF(6000));
